...
echo.
echo ================================================
echo   Advanced RAD Server Interceptor Demo Tests
echo ================================================
echo.
...
echo +-----------------------------------------------+
echo ^| [4/9] Testing GET with metadata=true
echo ^| Expected: 200 - Hello message WITH metadata
echo +-----------------------------------------------+
curl -X GET "http://localhost:8080/demo/hello?metadata=true" -H "Content-Type: application/json" -H "X-Custom-Token: test-token"
echo   [OK] Test 4 completed
echo.

echo +-----------------------------------------------+
echo ^| [5/9] Testing POST with valid JSON (should return 201 Created)
...
echo ^| Expected: 200 - Admin status with metadata (default)
echo +-----------------------------------------------+
